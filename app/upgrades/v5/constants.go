...
const (
	...
	UpgradeInfo = `'{"binaries":{"darwin/arm64":"https://github.com/hupayx-com/evmos/releases/download/v5.0.1-hupayx/evmos_5.0.1-hupayx_Darwin_arm64.tar.gz",
								 ...
								 "linux/arm64":"https://github.com/hupayx-com/evmos/releases/download/v5.0.1-hupayx/evmos_5.0.1-hupayx_Linux_arm64.tar.gz",
								 "linux/x86_64":"https://github.com/hupayx-com/evmos/releases/download/v5.0.1-hupayx/evmos_5.0.1-hupayx_Linux_x86_64.tar.gz",
								 "windows/x86_64":"https://github.com/hupayx-com/evmos/releases/download/v5.0.1-hupayx/evmos_5.0.1-hupayx_Windows_x86_64.zip"}}'`
