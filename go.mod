...
require (
	...
	github.com/hupayx-com/carrotMember v0.0.2
...
require github.com/tendermint/spm v0.1.8
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/hupayx-com/cosmos-sdk v0.44.9-hupayx
