module github.com/hupayx-com/evmos
...
require (
	...
	github.com/tharsis/evmos v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/tharsis/ethermint/types => /apps/evmos/types
	github.com/tharsis/evmos => /apps/evmos
